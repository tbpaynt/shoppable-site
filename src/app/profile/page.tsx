              ...
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors ${
                  activeTab === 'personal'
                    ...
                    : 'border-transparent text-gray-400 hover:text-gray-300 bg-gray-800'
                }`}
              >
                Personal Information
              </button>
              ...
              <div className="space-y-6">
                ...
                {paymentMethods.length === 0 ? (
                  <div className="text-center py-8 text-gray-400">
                    ...
                    <p className="text-sm text-gray-400">Add a payment method to make checkout faster</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {paymentMethods.map((method) => (
                      <div key={method.id} className="border border-gray-600 rounded-lg p-4 flex justify-between items-center bg-gray-700">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-400">{method.brand?.toUpperCase()} • Expires {method.exp_month?.toString().padStart(2, '0')}/{method.exp_year}</p>
                          </div>
                          {method.is_default && (
              ...
              <div className="space-y-6">
                ...
                {showAddAddress && (
                  <div className="bg-gray-700 p-6 rounded-lg">
                    <h3 className="text-lg font-medium mb-4 text-white">Add New Address</h3>
                    <form onSubmit={handleAddAddress} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="md:col-span-2">
                        <label className="block text-sm font-medium text-white mb-1">Address Line 2 (Optional)</label>
                        <input
                          type="text"
                ...
                {shippingAddresses.length === 0 ? (
                  <div className="text-center py-8 text-gray-400">
                    ...
                    <p className="text-white">No shipping addresses saved</p>
                    <p className="text-sm text-gray-400">Add an address to speed up checkout</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {shippingAddresses.map((address) => (
                      <div key={address.id} className="border border-gray-600 rounded-lg p-4 bg-gray-700">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <p className="text-gray-300">{address.street1}</p>
                            {address.street2 && <p className="text-gray-300">{address.street2}</p>}
